...
Stacks operate on “last in, first out” behavior. The last, most recently added item, is first to be removed. Queues, on the other hand, operate on “first in, first out” behavior. Items are removed in the order they were added, from first to last. 
